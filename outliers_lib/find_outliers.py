...
def find_outliers_quantile(data, feature, left=0.01, right=0.99):
    """
    Находит выбросы в данных, используя квантили. 
    
    Args:
        data (pandas.DataFrame): набор данных
        feature (str): имя признака, на основе которого происходит поиск выбросов
        left (float, optional): квантиль левой границы. По умолчанию - уровня 1.
        right (float, optional): квантиль правой границы. По умолчанию - уровня 99.
        
        Функция по умолчанию отсекает 2 процента наблюдений (1% слева и 1% справа)
