...
```
git clone https://github.com/Maximus1973/DataCleaningProject
```
...
Итак, мы с вами познакомились с основными проблемами «грязных данных» и способами их решения.

В нашем проекте мы рассмотрели:
